...
/**
 * SocialUserRecommendations Component
 * 소셜 탭 전용 사용자 추천 컴포넌트
 * - 홈의 UserRecommendations 로직 재사용
 * - 소셜 탭 맥락에 맞는 제목과 메시지
 */
...
export default function SocialUserRecommendations() {
    ...
    return (
      <div className="p-4 bg-white">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold">🎯 추천 이웃</h2>
  ...
  if (error) {
    return (
      <div className="p-4 bg-white">
        ...
        <p className="text-gray-500">이웃 추천을 불러올 수 없습니다</p>
      </div>
    )
  }
    ...
    return (
      <div className="p-4 bg-white">
        ...
        <div className="text-center py-8">
          <p className="text-gray-500 mb-2">아직 추천 이웃이 없습니다</p>
          <p className="text-sm text-gray-400">
            독서 키워드를 설정하면 취향 맞는 이웃을 추천해드려요
          </p>
        </div>
      </div>
    )
...
SocialUserRecommendations.displayName = 'SocialUserRecommendations'
