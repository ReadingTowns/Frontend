...
/**
 * 온보딩 키워드 2단계: 주제 (CONTENT)
 */
export default function Keywords2Step({
  selectedIds,
  onChange,
  onBack,
}: Keywords2StepProps) {
  ...
  const { data, isLoading, error } = useRecommendKeywordCandidates('CONTENT')
...
Keywords2Step.displayName = 'Keywords2Step'
