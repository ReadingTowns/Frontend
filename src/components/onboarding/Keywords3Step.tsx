...
/**
 * 온보딩 키워드 3단계: 분위기 (MOOD)
 */
export default function Keywords3Step({
  selectedIds,
  onChange,
  onBack,
}: Keywords3StepProps) {
  ...
  const { data, isLoading, error } = useRecommendKeywordCandidates('MOOD')
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-50">
      ...
      <div className="bg-white px-4 pt-6 pb-4 border-b border-gray-200">
        ...
        <p className="text-gray-600">원하는 분위기를 선택해주세요 (최소 1개)</p>
        <div className="mt-4">
...
Keywords3Step.displayName = 'Keywords3Step'
