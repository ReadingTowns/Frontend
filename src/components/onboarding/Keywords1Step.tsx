...
/**
 * 온보딩 키워드 1단계: 장르 (GENRE)
 */
export default function Keywords1Step({
  selectedIds,
  onChange,
  onBack,
}: Keywords1StepProps) {
  ...
  const { data, isLoading, error } = useRecommendKeywordCandidates('GENRE')
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-50">
      ...
      <div className="bg-white px-4 pt-6 pb-4 border-b border-gray-200">
        ...
        <p className="text-gray-600">관심있는 장르를 선택해주세요 (최소 1개)</p>
        <div className="mt-4">
...
Keywords1Step.displayName = 'Keywords1Step'
